...
public class DeleteCollectionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    boolean deleteCollectionResult = hCollectionsDao.deleteCollections(haidaxueSn, questionSn, answersSn);

	    JSONArray jsonArray = new JSONArray();
    	JSONObject jsonobject = JSONObject.fromObject(deleteCollectionResult);
