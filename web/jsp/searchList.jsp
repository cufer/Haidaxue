...
function searchServlet(){
	$.ajax({  
        url: "/search",  //servlet mapping + 传参  ——  servlet中request.get获取
        type: "post",  
        dataType: "json",  
        timeout: 1000,  
        cache: false,  
...
/*            $("#showUUU").append($("<li><a href = 'questionDetail.jsp?question_sn="+json[index].questionSn>+"'><img src = '../images/"+json[index].questionContent+"' />"+
			...
			$("#showUUU").append($("<li><a href = '/detail?questionSn="+json[index].questionSn+"' data-ajax='false'><img src = '../images/"+json[index].userPic+"' />"+
					"<h2>"+json[index].questionLabel+"</h2>"+
...
<body onload ="searchServlet()">
<div data-role="page" data-theme="a" data-title="searchList" id="searchList">
		<!--page开始 -->
